...
\begin{equation}
  ...
  \label{eq:s2z}
\end{equation}
Making a substitution $t^{-1} = z + z^{-1}$ and inverting Z-transform for
$s_2(t)$ we will get a sequence $S_2(r) = (S_2(0), S_2(1), S_2(2), \dots)$ up to
a normalization by $N(r)$. The meaning of this sequence is a number of positive
elements in $a$ distanced by $r$.
\begin{example}
